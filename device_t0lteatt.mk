...
PRODUCT_COPY_FILES += \
        ...
        device/samsung/t0lte/recovery/poweroff.sh:root/sbin/poweroff.sh \
        device/samsung/t0lte/modules/exfat_fs.ko:root/system/lib/modules/exfat_fs.ko \
        device/samsung/t0lte/modules/exfat_core.ko:root/system/lib/modules/exfat_core.ko \
	...
	device/samsung/t0lte/recovery/runatboot.sh:root/sbin/runatboot.sh
